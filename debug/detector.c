    ...
    float hier_thresh, int dont_show, int ext_output, int save_labels, char *outfile, int letter_box, int benchmark_layers)
{
    ...
    printf("net cok: %d, %d, %d, %d, %d ", net.adam, net.w, net.h, net.c, net.n);
    printf("\n");
    ...
    while (1) {
        if (filename) {
            ...
            printf("Detector Enter Image Path: ");
            fflush(stdout);
        ...
        printf("image im: %d, %d, %d, \n %f", im.w, im.h, im.c, im.data);
        // printf(im.data);
        printf("\n");
        ...
        float *X = sized.data;
        printf("Data cok: %f\n", *X);
        printf("output %f, %f, %f, %f, %f\n", net.output, net.outputs, net.output_gpu, net.output16_gpu, net.max_output16_size);
