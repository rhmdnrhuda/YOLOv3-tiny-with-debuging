...
void forward_yolo_layer(const layer l, network_state state)
{
    ...
    printf("l.output 2:  %f\n", l.output[0]);
#ifndef GPU
    printf("l.batch: %d, l.h: %d, l.w: %d, l.n: %d, max_boxes: %d, size: %d\n", l.batch, l.h, l.w, l.n, l.max_boxes, l.outputs*l.batch * sizeof(float));

    for (b = 0; b < l.batch; ++b) {
        for (n = 0; n < l.n; ++n) {
            // printf("l.classes %d \n", l.classes); output 24
            int index = entry_index(l, b, n*l.w*l.h, 0);
            int idx = entry_index(l, b, n*l.w*l.h, 4);
            // printf("\nb - a before cok: Index: %d, l.output[index]: %f, l.outputs: %d\n", idx, l.output[idx], l.outputs);
            activate_array(l.output + index, 2 * l.w*l.h, LOGISTIC);        // x,y,
            // printf("a: Index: %d, l.output[index]: %f, l.outputs: %d\n", index, l.output[index], l.outputs);
            // printf("b - a cok: Index: %d, l.output[index]: %f, l.outputs: %d\n", idx, l.output[idx], l.outputs);
        ...
        // printf("\n\n\n");
            ...
            // printf("a-b cok: Index: %d, l.output[index]: %f, l.outputs: %d\n", saveidx, l.output[saveidx], l.outputs);

            printf("b: Index: %d, l.output[index]: %f, l.outputs: %d\n\n", index, l.output[index], l.outputs);
        // printf("\n\n\n\n\n");
...
{
    printf("correct_yolo_boxes  \n");
    printf("n: %d, w: %d, h: %d, netw: %d, neth: %d, relative: %d, letter: %d\n", n,w,h,netw,neth,relative,letter);
...
{
    printf("yolo_num_detections lw: %d, l.h: %d, l.n: %d. thresh: %f l.ouputs: %d\n", l.w, l.h, l.n, thresh, l.outputs);
